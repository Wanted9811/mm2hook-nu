...
namespace MM2
{
    ...
    public:
        ...
        */
        ...
        virtual AGE_API int Init(const char* basename, const Matrix34& matrix, int flags) override;
    ...
    public:
        ...
        */
        ...
        virtual AGE_API int IsVisible(const gfxViewport& viewport);
        virtual AGE_API const Matrix34& GetMatrix(Matrix34& matrix);
        virtual AGE_API void SetMatrix(const Matrix34& matrix);
