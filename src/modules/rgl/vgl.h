...
namespace MM2
{
    ...
    extern void tglDrawFlatParticle(const Matrix34& matrix, const Vector3& position, float size, const Vector4 &color, dgBangerGlowData* glowData = nullptr, gfxTexture* defaultGlowTexture = nullptr);
