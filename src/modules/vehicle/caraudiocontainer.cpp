...
AGE_API void vehCarAudioContainer::StartSiren()                               { hook::Thunk<0x4D18B0>::Call<void>(this); }
AGE_API void vehCarAudioContainer::StopSiren()                                { hook::Thunk<0x4D18C0>::Call<void>(this); }
