...
ECHO MSVC build tools path set to %MSVC_BUILDTOOLS_PATH%
...
:endinput
SET "VCVARS_PATH=%MSVC_BUILDTOOLS_PATH%%VCVARS%"
SET "MSBUILD_PATH=%MSVC_BUILDTOOLS_PATH%%MSBUILD%"

CALL "%VCVARS_PATH%" x86 10.0.19041.0
